...
- **Show all locations as list**
Use the shortcode [open-user-map-list] to get a list view of all the locations.
...
to display a value from a location. You will need this when creating single pages for locations. See all the available values in the Help section of the plugin settings (Open User Map > Settings > Help & Getting started).
